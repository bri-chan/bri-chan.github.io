export const pages = [
  ...
  { index: 5, name: 'certificates.md', route: '/certificates', visible: false },
  { index: 6, name: 'coursework.md', route: '/coursework', visible: true },
  { index: 7, name: 'accomplishments.md', route: '/accomplishments', visible: true },    
];
